      ...
      <Container>
        ...
        >
          ...
          <p className="text-base sm:text-lg md:text-xl text-gray-600 max-w-3xl mx-auto px-4 sm:px-0">
            ...
            who ministered together in unity and purpose—like Peter and Andrew, James and John, Moses and Aaron.
          </p>
        </motion.div>
        ...
        >
          <div className="bg-tgm-gold/5 border border-tgm-gold/20 rounded-lg p-4 sm:p-6 md:p-8 max-w-4xl mx-auto">
            ...
            <cite className="text-sm sm:text-base text-tgm-gold">Hebrews 4:16</cite>
          </div>
        </motion.div>
      </Container>
    </section>
